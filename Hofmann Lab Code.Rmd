...
omegas <- data.frame(trisdata$voltage_1_m_v,trisdata$voltage_2_m_v,trisdata$voltage_3_m_v,trisdata$voltage_4_m_v) %>% # create OMEGAS data frame with the tris voltages
  mutate(v1=as.numeric(trisdata.voltage_1_m_v),
         v2=as.numeric(trisdata.voltage_2_m_v),
         v3=as.numeric(trisdata.voltage_3_m_v),
         v4=as.numeric(trisdata.voltage_4_m_v)) %>%
  select(v1, v2, v3, v4)
         
         ) %>%
  mutate(v2=..s,dfa,.sdmf)
